          ...
          <div className="home-header-contents">
            <div className="left-contents">
              ...
              <div
                ...
                onClick={() => this.handleWebLogoClicked()}
              ></div>
            </div>
            ...
            <div className="right-contents">
              ...
              <div
                className="header-user-account-section"
                onClick={(isLoggedIn) =>
                  this.handleLoginForUser(this.props.isLoggedIn)
                }
              >
                ...
                <div
                  className={
                    language === LANGUAGES.VI
                      ? "header-user-nation-icon"
                      : "header-user-nation-icon active"
                  }
                ></div>
              </div>
            </div>
            ...
            <nav>
              <ul id="home-top-navigator">
                ...
                <li>
                  <FontAwesomeIcon
                    icon={faHeartPulse}
                    className="nav-icon fontawesome-icon"
                  />
                ...
                <FormattedMessage id="home-banner.search-area-search-box-placeholder">
                  {(placeholderText) => (
                    <input
                      ...
                      onChange={(event) =>
                        this.handleOnChangeSearchInput(event)
                      }
          ...
          <div className="sidebar">
            ...
            <div className="home-page-side-bar-language-option">
              <div
                className={
                  language === LANGUAGES.VI
                    ? "vietnamese-option active"
                    : "vietnamese-option"
                }
                onClick={() => this.switchLanguageOfWebsite(LANGUAGES.VI)}
              ></div>
              <div
                className={
                ...
                onClick={() => this.switchLanguageOfWebsite(LANGUAGES.EN)}
              ></div>
            </div>
          </div>
        </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    switchLanguageOfWebsite: (language) =>
      dispatch(switchLanguageOfWebsite(language)),
