        ...
        <div className="medical-facilities-section-contents">
          <div className="medical-facilities-section-title-section">
            ...
            <div className="more-detail-button">
              <a href={path.ALL_MEDICAL_FACILITIES} className="button">
              ...
              arrMedicalFacility.map((item, index) => {
                ...
                return (
                  <div
                    ...
                    key={index}
                    onClick={() =>
                      this.handleViewDetailArticleOfAFacility(item.id)
                    }
                  >
...
const mapDispatchToProps = (dispatch) => {
  return {
    loadMedicalFacilities: (id) =>
      dispatch(actions.getBriefInfoOfMedicalFaclityAction(id)),
  };
};

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MedicalFacilitiesSection)
);
