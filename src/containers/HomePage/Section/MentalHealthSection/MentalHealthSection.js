                ...
                <div className="mental-health-contents">
                    <div className="mental-health-section-title">
                        <div className="title-text">
                            <FormattedMessage id="mental-health-section.mental-health-section-title" />
                        </div>

                        <div className="more-detail-button">
                            <a href="#" className="button">
                                <FormattedMessage id="mental-health-section.button-more-detail" />
                            </a>
                        </div>
                    </div>
                    ...
                    <Slider {...settings}>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content">
                                    <FormattedMessage id="mental-health-section.option-1" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content">
                                    <FormattedMessage id="mental-health-section.option-2" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content">
                                    <FormattedMessage id="mental-health-section.option-3" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content">
                                    <FormattedMessage id="mental-health-section.option-4" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content">
                                    <FormattedMessage id="mental-health-section.option-5" />
                                </div>
                            </div>
                        </div>
                    </Slider>
