                    ...
                    <Slider {...settings}>
                        {arrRemoteSpecialty &&
                            ...
                            arrRemoteSpecialty.slice(0, 15).map((item, index) => {
                                ...
                                return (
                                    <div className="item-content" key={index} onClick={() => this.handleViewDetailArticleOfASpecialty(item)}>
                                        <div className="item-of-slider">
                                            <div className="image-css" style={{ backgroundImage: `url(${imageByBase64})` }}></div>
                                            <div className="item-content">{language === LANGUAGES.VI ? nameInVie : nameInEng}</div>
                                        </div>
                                    </div>
                                );
                            })}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RemoteExamSection));
