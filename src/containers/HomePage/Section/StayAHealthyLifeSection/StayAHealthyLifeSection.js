                    ...
                    <Slider {...settings}>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-1" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-2" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-3" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-4" />
                                </div>
                        ...
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-5" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-6" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-7" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-8" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-9" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-10" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-11" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-12" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-13" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-14" />
                                </div>
                            </div>
                        </div>
                        <div className="item-content">
                            <div className="item-of-slider">
                                ...
                                <div className="item-content"><FormattedMessage id="stay-a-healthy-life-section.article-15" />
                                </div>
                            </div>
                        </div>
