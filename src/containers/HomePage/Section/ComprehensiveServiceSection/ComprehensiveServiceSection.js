      ...
      <div className="comprehensive-service-section">
        ...
        <div className="service-contents">
          <div className="left-contents">
            <div
              className="specialty-exam content-background "
            ...
            <div
              className="general-exam content-background"
            ...
            <div
              className="health-checkup content-background"
          ...
          <div className="right-contents">
            ...
            <div
              className="dental-health content-background"
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ComprehensiveServiceSection)
);
