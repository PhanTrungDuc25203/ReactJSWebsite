        ...
        return (
            <div className="comprehensive-service-section">
                <div className="section-title">
                    <FormattedMessage id="comprehensive-service-section.section-title" />
                </div>
                <div className="service-contents">
                    <div className="left-contents">
                        <div className="specialty-exam content-background " onClick={() => this.handleClickToAllSpecialties()}>
                            <div className="service-icon-container">
                                <div className="specialty-icon"></div>
                            </div>
                            <FormattedMessage id="comprehensive-service-section.option-specialty-exam" />
                        </div>
                        <div className="general-exam content-background" onClick={() => this.handleClickToGeneralExamPage()}>
                            <div className="service-icon-container">
                                <div className="check-list-icon"></div>
                            </div>
                        ...
                        <div className="health-checkup content-background" onClick={() => this.handleClickToHealthCheckPage()}>
                            <div className="service-icon-container">
                                <div className="health-checkup-icon"></div>
                            </div>
                    ...
                    <div className="right-contents">
                        ...
                        <div className="healthy-with-diabetes content-background">
                            <div className="service-icon-container">
                                <div className="blood-glucose-meter-icon"></div>
                            </div>
