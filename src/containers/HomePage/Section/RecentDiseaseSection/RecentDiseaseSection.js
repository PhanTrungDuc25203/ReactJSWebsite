            ...
            <div className="information-source">
              ...
              <div className="source-image">
                <a
                  ...
                  className="source-1 image-css"
                >
                  {/* <div className="source-1 image-css"></div> */}
                </a>
                <a
                  href="https://vtv.vn/tim-kiem.htm?type=3&keywords=b%E1%BB%87nh"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="source-2 image-css"
                >
                  {/* <div className="source-2 image-css"></div> */}
                </a>
                <a
                  href="https://timkiem.vnexpress.net/?search_q=b%E1%BA%A1ch%20h%E1%BA%A7u%27&cate_code=&media_type=all&latest=&fromdate=&todate=&date_format=all&"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="source-3 image-css special-image-css"
                >
                  {/* <div className="source-3 image-css special-image-css"></div> */}
                </a>
                <a
                  href="https://dantri.com.vn/tim-kiem/b%E1%BA%A1ch+h%E1%BA%A7u.htm"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="source-4 image-css"
                >
