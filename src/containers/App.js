          ...
          <div className="main-container">
            ...
            <div className="content-container">
              ...
              <Switch>
                ...
                <Route
                  path={path.REGISTER}
                  component={userIsNotAuthenticated(DefaultRegister)}
                />
                {/* dành cho admin  */}
                <Route
                  path={path.SYSTEM}
                  component={userIsNotPatientAndDoctor(
                    userIsNotPatient(userIsAuthenticated(System))
                  )}
                />
                {/* booking care cho bác sĩ và bệnh nhân*/}
                <Route path={path.HOMEPAGE} component={HomePage} />
                <Route
                  path={path.DETAIL_DOCTOR_ARTICLE}
                  component={DetailArticleForADoctor}
                />
                {/* trang dăng kí khám bệnh theo khung giờ của từng bác sĩ cho bệnh nhân */}
                <Route
                  path={path.MAKE_APPOINTMENT_WITH_DOCTOR}
                  component={MakeAppointmentPage}
                />
                {/* trang dăng kí Gói khám cho bệnh nhân */}
                <Route
                  path={path.BOOKING_A_EXAM_PACKAGE}
                  component={BookingAExamPackagePage}
                />
                {/* route xác nhận đặt hẹn với bác sĩ */}
                <Route
                  path={path.CONFIRM_BOOKING_APPOINTMENT}
                  component={ConfirmBookingAppointment}
                />
                {/* route trang chi tiết một chuyên khoa và các bac sĩ thuộc chuyên khoa đó */}
                <Route
                  path={path.SPECIALTY_ARTICLE}
                  component={DetailSpecialty}
                />
                {/* trang xem thông tin của một cơ sở y tế */}
                <Route
                  path={path.MEDICAL_FACILITY_ARTICLE}
                ...
                <Route
                  path={path.ALL_MEDICAL_FACILITIES}
                  component={AllMedicalFacilities}
                />
                ...
                <Route
                  path={"/doctor"}
                  component={userIsNotPatient(userIsAuthenticated(Doctor))}
                />
              </Switch>
              {/* </CustomScrollbars> */}
            </div>
