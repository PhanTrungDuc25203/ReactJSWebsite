                        ...
                        <div className="content-left">
                            ...
                            <div className="doctor-relative">
                                ...
                                <div className="text-content">
                                    <div className="doctor-general-infor">{packageDetails && packageDetails.name}</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BookingAExamPackagePage);
