...
class BookingAExamPackagePage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      packageDetails: {},
  ...
  render() {
    ...
    if (packageDetails.image) {
      imageByBase64 = Buffer.from(packageDetails.image, "base64").toString(
        "binary"
      );
    }
            ...
            <div className="content-left">
              ...
              <div className="doctor-relative">
                <div
                  ...
                  style={{
                    backgroundImage: `url(${
                      imageByBase64 ? imageByBase64 : defaultAvatar
                    })`,
                  }}
                ></div>
              ...
              <div className="patient-relative">
                <div className="exam-price">
                  ...
                  <div className="price">
                    {packageDetails &&
                      packageDetails.priceDataForPackage &&
