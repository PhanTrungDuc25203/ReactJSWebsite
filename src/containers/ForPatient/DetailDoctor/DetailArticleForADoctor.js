                    ...
                    <div className="avatar-and-general-introduction">
                        ...
                        <div className="right-content">
                            <div className="general-introduction">
                                <div className="name-and-position">{language === LANGUAGES.VI ? nameInVie : nameInEng}</div>
                                        ...
                                        <span>
                                            ...
                                            <FontAwesomeIcon icon={faMapLocationDot} className="location-icon" />
                                            {
                                                ...
                                                language === LANGUAGES.VI
                                                    ? doctorDetails && doctorDetails.Doctor_infor && doctorDetails.Doctor_infor.provinceTypeData && doctorDetails.Doctor_infor.provinceTypeData.value_Vie
                                                        ? doctorDetails.Doctor_infor.provinceTypeData.value_Vie
                                                        : "Chưa cập nhật vị trí"
                                                    : doctorDetails && doctorDetails.Doctor_infor && doctorDetails.Doctor_infor.provinceTypeData && doctorDetails.Doctor_infor.provinceTypeData.value_Eng
                                                    ? doctorDetails.Doctor_infor.provinceTypeData.value_Eng
                                                    : "Address nto updated yet"
                                            }
                                        </span>
                                    )}
                                </div>
                        ...
                        {doctorDetails?.ArticleMarkdown?.htmlContent && (
                            <div
                                dangerouslySetInnerHTML={{
                                    __html: doctorDetails.ArticleMarkdown.htmlContent,
                                }}
                                className="doctor-CV-html"
                            ></div>
                        )}
                    </div>
