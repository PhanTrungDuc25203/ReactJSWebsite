...
const DoctorScheduleSection = React.lazy(() =>
  import("./DoctorScheduleSection")
);
const DoctorExtraInforSection = React.lazy(() =>
  import("./DoctorExtraInforSection")
);
                      ...
                      />
                      {
                        ...
                        language === LANGUAGES.VI
                          ? doctorDetails &&
                            ...
                            doctorDetails.Doctor_infor.provinceTypeData &&
                            doctorDetails.Doctor_infor.provinceTypeData
                              .value_Vie
                            ? doctorDetails.Doctor_infor.provinceTypeData
                                .value_Vie
            ...
            <Suspense fallback={<div>Loading schedule...</div>}>
              <div className="left-content-timeframe">
                <DoctorScheduleSection
                  selectedDoctorId={doctorDetails.id || -1}
                />
              </div>
            </Suspense>
