      ...
      <React.Fragment>
        <div className="appointment-address-sct1">
          ...
          <div className="clinic-name-and-address">
            <div>
              {extraInfor && extraInfor.clinicName
                ? extraInfor.clinicName
                : "Phòng khám của bác sĩ chưa được cập nhật"}
            </div>
            <div>
              {extraInfor && extraInfor.clinicAddress
                ? extraInfor.clinicAddress
                : ""}
            </div>
          </div>
        </div>
          ...
          {isShowInsurenceDetail === false ? (
            ...
            <div className="insurance-detail">
              <div className="insurance-type-1">
                ...
                <div className="section-content">
                  Áp dụng với Bảo hiểm y tế hạng 3 (bao gồm BHYT ở Phường, Quận
                  TPHCM và Tỉnh)
                </div>
              </div>
