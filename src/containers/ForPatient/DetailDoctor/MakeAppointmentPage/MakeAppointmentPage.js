                        ...
                        <div className="content-left">
                            ...
                            <div className="doctor-relative">
                                ...
                                <div className="text-content">
                                    <div className="doctor-general-infor">{language === LANGUAGES.VI ? nameInVie : nameInEng}</div>
                            ...
                            <div className="patient-relative">
                                <div className="exam-price">
                                    ...
                                    <div className="price">
                                        {doctorDetails.Doctor_infor && doctorDetails.Doctor_infor.priceTypeData && language === LANGUAGES.EN && <NumericFormat value={doctorDetails.Doctor_infor.priceTypeData.value_Eng} displayType="text" thousandSeparator="," suffix="$" />}
                                        {doctorDetails.Doctor_infor && doctorDetails.Doctor_infor.priceTypeData && language === LANGUAGES.VI && <NumericFormat value={doctorDetails.Doctor_infor.priceTypeData.value_Vie} displayType="text" thousandSeparator="," suffix="đ" />}
                                    </div>
                                </div>
                                    ...
                                    <div className="name-section">
                                        ...
                                        <div className="icon-and-input">
                                            ...
                                            <input
                                                type="text"
                                                value={
                                                    currentSystemUser && currentSystemUser.lastName && currentSystemUser.firstName
                                                        ? language === LANGUAGES.VI
                                                            ? currentSystemUser.lastName + " " + currentSystemUser.firstName
                                    ...
                                    <div className="gender-section">
                                        ...
                                        {this.state.genderList &&
                                            ...
                                            this.state.genderList.map((gender) => (
                                                <div key={gender.id}>
                                                    <input className="radio-button-for-gender" type="radio" id={gender.keyMap} name="gender" value={gender.keyMap} checked={this.state.selectedGender === gender.keyMap} disabled={!!this.state.selectedGender} onChange={this.handleGenderChange} />
