...
class PackageScheduleComponent extends Component {
  ...
  render() {
    let { packagerDetails, isShowPriceDetail, isShowInsurenceDetail } =
      this.state;
    ...
    if (packagerDetails && packagerDetails.image) {
      imageByBase64 = Buffer.from(packagerDetails.image, "base64").toString(
        "binary"
      );
    }
        ...
        <div className="schedule-and-insurance">
          <div className="schedule">
            <PackageScheduleSection
              selectedPackageId={packagerDetails.id || -1}
            />
          </div>
          <div className="detail-informations">
            <div className="price">
              <div
                className={
                  isShowPriceDetail === false
                    ? "examination-price-sct2 css-for-less-content"
                    : "examination-price-sct2"
                }
              >
                ...
                {isShowPriceDetail === false ? (
                  <React.Fragment>
                    <div className="examination-price">
                      {packagerDetails &&
                        packagerDetails.priceDataForPackage &&
                        language === LANGUAGES.EN && (
                          <NumericFormat
                            value={
                              packagerDetails.priceDataForPackage.value_Eng
                            }
                            displayType="text"
                            thousandSeparator=","
                            suffix="$"
                      ...
                      {packagerDetails &&
                        ...
                        language === LANGUAGES.VI && (
                          <NumericFormat
                            value={
                              packagerDetails.priceDataForPackage.value_Vie
                            }
                            displayType="text"
                            thousandSeparator=","
                            suffix="đ"
                    ...
                    <button
                      ...
                      onClick={() =>
                        this.handleMoreButtonClicked(true, "price")
                      }
                    >
                  ...
                  <div className="price-detail">
                    ...
                    <div className="sale-method">
                      Phòng khám hỗ trợ cách hình thức: Chuyển khoản, quẹt thẻ
                      và tiền mặt
                    </div>
                    ...
                    <div className="less-button-container">
                      <button
                        ...
                        onClick={() =>
                          this.handleMoreButtonClicked(false, "price")
                        }
                      >
            ...
            <div className="insurance">
              <div
                className={
                  isShowInsurenceDetail === false
                    ? "insurance-sct3 css-for-less-content"
                    : "insurance-sct3"
                }
              >
                ...
                {isShowInsurenceDetail === false ? (
                  <React.Fragment>
                    <button
                      className="more-button"
                      onClick={() =>
                        this.handleMoreButtonClicked(true, "insurance")
                      }
                    >
                      <FormattedMessage id="doctor-detail-page-for-patient.extra-infor-section.more-button" />
                    </button>
                  ...
                  <div className="insurance-detail">
                    <div className="insurance-type-1">
                      ...
                      <div className="section-content">
                        Áp dụng với khách hàng đăng kí khám chữa bệnh ban đầu
                        tại phòng khám, trung tâm y tế bệnh viện tuyến quận
                        huyện tại TP. HCM. Khách hàng có giấy chuyển viện tuyến
                        3-4 ở tỉnh đến khám hoặc các trường hợp cấp cứu.(áp dụng
                        từ ngày 01/04/2023)
                      </div>
                    </div>
                    <div className="insurance-type-2">
                      ...
                      <div className="section-content">
                        Đối với các đơn vị bảo hiểm không bảo lãnh trực tiếp:
                        Bệnh viện xuất hoá đơn tài chính (hoá đơn điện tử) và hỗ
                    ...
                    <div className="less-button-container">
                      <button
                        className="less-button"
                        onClick={() =>
                          this.handleMoreButtonClicked(false, "insurance")
                        }
                      >
                        <FormattedMessage id="doctor-detail-page-for-patient.extra-infor-section.less-button" />
                      </button>
