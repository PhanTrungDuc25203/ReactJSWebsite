...
class SearchPage extends Component {
    ...
    render() {
        ...
        let { specialty = { tag: "none", data: [] }, exam_package = { tag: "none", data: [] }, doctor = { tag: "none", data: [] }, complex_facility = { tag: "none", data: [] } } = this.state.searchResult || {};
                    ...
                    <div className="search-result-container">
                        {this.state.isLoading ? (
                            ...
                            <>
                                ...
                                {(filter === "" || filter === "doctor") && doctor.tag !== "none" && <DoctorResult doctorResult={doctor} />}

                                {(filter === "" || filter === "exam_package") && exam_package.tag !== "none" && <ExamPackageResult examPackageResult={exam_package} />}

                                {(filter === "" || filter === "complex_facility") && complex_facility.tag !== "none" && <MedicalFacilityResult facilityResult={complex_facility} />}
                            </>
                        )}
                    </div>
                </div>
...
const mapDispatchToProps = (dispatch) => {
    return {
        search: (searchterm, filter) => dispatch(actions.fetchDataForAllMedicalServiceFilterSearch(searchterm, filter)),
    };
};
