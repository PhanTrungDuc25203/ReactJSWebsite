...
class ExamPackageManage extends Component {
  ...
  async componentDidUpdate(prevProps, prevState, snapshot) {
    if (prevProps.requiredPackageData !== this.props.requiredPackageData) {
      let { resPrice, resMedicalFacility, resSpecialty } =
        this.props.requiredPackageData;
      let selectPriceData = this.buildDataForSelectBox(
        resPrice,
        "priceSelection"
      );
      let selectMedicalFacilityData = this.buildDataForSelectBox(
        resMedicalFacility,
        "medicalFacilitySelection"
      );
      let selectSpecialtyData = this.buildDataForSelectBox(
        resSpecialty,
        "specialtySelection"
      );
      this.setState({
  ...
  render() {
    return (
      <div className="exam-package-manage-container">
        <div className="exam-package-manage-form-title title mb-4">
          Thông tin cho Gói khám bệnh của Cơ sở Y tế
        </div>
        <div className="container mt-5">
          <div className="row">
            <div className="col-md-8 information-container">
              <div className="row row-in-form">
                <div className="col-md-6 mb-3">
                  <label className="facility-manage-page-title">
                    Tên của Gói khám
                  </label>
                  <input
                    type="text"
            ...
            <div className="col-md-4 image-preview-section">
              <div className="image-preview-container">
                <label className="facility-manage-page-title">
                  Ảnh đại diện Gói khám (Logo, tên viết tắt,...)
                </label>
                <div
          ...
          <label className="facility-manage-page-title">
            Bài báo giới thiệu chung về Gói khám
          </label>
          ...
          <div className="save-facility-button">
            <button onClick={() => this.handleSaveExamPackageInformation()}>
              Thêm Gói khám cho Cơ sở y tế
            </button>
          </div>
        </div>
      </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    getRequiredDataForExamPackageManagePage: () =>
      dispatch(actions.getRequiredDataForExamPackageManagePage()),
  };
};
