  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.usersFromRedux !== this.props.usersFromRedux) {
      ...
      this.setState({
        ...
        address: "",
        gender:
          tempGenderArr && tempGenderArr.length > 0
            ? tempGenderArr[0].keyMap
            : "",
        position:
          tempPositionArr && tempPositionArr.length > 0
            ...
            : "",
        role:
          tempRoleArr && tempRoleArr.length > 0 ? tempRoleArr[0].keyMap : "",
        avatarImage: "",
        previewAvatarImageUrl: "",
                  ...
                  <Col md={2} className="avatar-image-section">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        type="file"
                        onChange={(event) =>
                          this.handleOnChangeAvatarImage(event)
                        }
                        hidden
                      />
                      <label
                        className="upload-avatar-image"
                        htmlFor="addUserAvatar"
                      >
                    ...
                    <FormGroup>
                      ...
                      <Col sm={12}>
                        <Input
                          ...
                          value={gender}
                          placeholder={
                            isLoadingGenderValue === true
                              ? `Loading gender's value`
                              : ""
                          }
                        >
