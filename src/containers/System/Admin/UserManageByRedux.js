...
class UserManageByRedux extends Component {
    ...
    render() {
        ...
        let { email, password, firstName, lastName, phoneNumber, address, gender, position, role, avatarImage } = this.state;
        return (
                    ...
                    <div className="container">
                        <div className="form-contents-container">
                            <Form>
                                <Row>
                                    ...
                                    <Col md={2} className="avatar-image-section">
                                        <FormGroup>
                                            ...
                                            <Input id="addUserAvatar" name="avatar" type="file" onChange={(event) => this.handleOnChangeAvatarImage(event)} hidden />
                                            <label className="upload-avatar-image" htmlFor="addUserAvatar">
                                                ...
                                                <FontAwesomeIcon icon={faFileUpload} className="fontawesome-icon" />
                                            </label>
                                            <label className="delete-btn" onClick={() => this.deleteSelectedAvatarImage()}>
                                                <FormattedMessage id="menu.admin.user-manage-by-redux-form.image-delete" />
                                                <FontAwesomeIcon icon={faTrashAlt} className="fontawesome-icon" />
                                            </label>
                                        </FormGroup>
                                    </Col>
                                    <Col md={4} className="avatar-image-section">
                                        <FormGroup>
                                            <Label>
                                                <FormattedMessage id="menu.admin.user-manage-by-redux-form.image-preview" />
                                            </Label>
                                            <div
                                ...
                                <Row>
                                    <Col md={12}>
                                        <Button className={this.state.action === CRUD_ACTIONS.EDIT ? "edit-user-button" : "add-new-user-button"} onClick={() => this.handleAddNewUser()}>
                                            {this.state.action === CRUD_ACTIONS.EDIT ? <FormattedMessage id="menu.admin.user-manage-by-redux-form.save-changes-button" /> : <FormattedMessage id="menu.admin.user-manage-by-redux-form.add-new-button" />}
                        ...
                        <div className="user-display-table">
                            <UserDisplayTableByRedux editUserByReduxFromParent={this.editUserByRedux} action={this.state.action} />
                        </div>
                    </div>
                    {this.state.imagePreviewOpened === true && <Lightbox mainSrc={this.state.previewAvatarImageUrl} onCloseRequest={() => this.setState({ imagePreviewOpened: false })} />}
                </div>
            </div>
        );
    }
