            ...
            <div className="doctor-manage-container">
                ...
                <div className="header-article-container">
                    <div className="more-info-for-a-doctor">
                        <textarea placeholder={language === LANGUAGES.VI ? "Thông tin giới thiệu..." : "Introduction information..."} onChange={(event) => this.handleOnChangeText(event, "description")} value={this.state.description}></textarea>
                    </div>

                    <div className="option-section">
                        <button className={hadOldDataForEdit === true ? "save-changes-of-doctor-article-button" : "save-doctor-article-button"} onClick={() => this.handleSaveMarkdownContent()}>
                            {hadOldDataForEdit === true ? (
                                <span>
                ...
                <div className="extra-infor-container">
                    <div className="row row-in-form">
                        ...
                        <div className="col-md-3 mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="Địa chỉ phòng khám..." required onChange={(event) => this.handleOnChangeText(event, "clinicAddress")} value={this.state.clinicAddress}></input>
                        </div>
                        <div className="col-md-3 mb-3">
                            <label>Tên phòng khám</label>
                            <input type="text" className="form-control" placeholder="Tên phòng khám..." required onChange={(event) => this.handleOnChangeText(event, "clinicName")} value={this.state.clinicName}></input>
                        </div>
                        <div className="col-md-3 mb-3">
                    ...
                    <div className="row row-in-form">
                        ...
                        <div className="col-md-3 mb-3">
                            <label>Ghi chú</label>
                            <input type="text" className="form-control" placeholder="Ghi chú..." required onChange={(event) => this.handleOnChangeText(event, "note")} value={this.state.note}></input>
                        </div>
                ...
                <div className="editor-lite-for-doctor-article">
                    <MdEditor style={{ height: "500px" }} renderHTML={(text) => mdParser.render(text)} onChange={this.handleEditorChange} value={this.state.markdownContent} />
                </div>
            </div>
        );
    }
