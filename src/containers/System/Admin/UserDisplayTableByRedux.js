                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className="action-column-redux">
                                                <button className="modify-data-button-redux edit-button-redux" onClick={() => this.handleEditUserByRedux(item)}>
                                                    <i className="fas fa-pencil-alt"></i>
                                                </button>
                                                <button className="modify-data-button-redux delete-button-redux" onClick={() => this.handleDeleteUserByRedux(item)}>
