...
class MedicalFacilityManage extends Component {
    ...
    checkInputValidation = () => {
        let isValid = true;
        let needCheckInput = ["medicalFacilityName", "selectedProvince", "medicalFacilityAddress", "selectedSpecialty", "image", "htmlDescription", "markdownEquipment"];
            ...
            <div className="medical-facility-manage-container">
                ...
                <div className="container mt-5">
                        ...
                        <div className="col-md-8 information-container">
                            <div className="row row-in-form">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="text" className="form-control text-input" placeholder="Bệnh viện/phòng khám..." required onChange={(event) => this.handleOnChangeText(event, "medicalFacilityName")} value={this.state.clinicName} />
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label className="facility-manage-page-title">Tỉnh thành</label>
                                    <Select value={this.state.selectedProvince} onChange={this.handleChangeSelectProvince} options={this.state.provinceOptions} className="province-option" name="selectedProvince" />
                                </div>
                                ...
                                <div className="col-md-12 mb-3">
                                    ...
                                    <Select isMulti closeMenuOnSelect={false} value={this.state.selectedSpecialty} onChange={this.handleChangeSelectSpecialty} options={this.state.specialtyOptions} className="service-options" name="selectedServices" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="editor-lite-for-medical-facility-equipments">
                        <MdEditor style={{ height: "500px" }} renderHTML={(text) => mdParser.render(text)} onChange={this.handleEditorForEquipmentChange} value={this.state.markdownContent} />
                    </div>
                    <div className="save-facility-button">
                        <button onClick={() => this.handleSaveMedicalFacilityInformation()}>Thêm cơ sở Y tế</button>
                    </div>
                </div>
            </div>
        );
