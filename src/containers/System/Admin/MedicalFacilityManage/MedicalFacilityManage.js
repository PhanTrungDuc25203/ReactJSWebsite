...
class MedicalFacilityManage extends Component {
  ...
  async componentDidMount() {
    try {
      ...
      if (res && res.specialtyData && res.provinceData) {
        let specialtyOptions = this.buildDataForSelectBox(
          res.specialtyData,
          "specialtySelection"
        );
        let provinceOptions = this.buildDataForSelectBox(
          res.provinceData,
          "provinceSelection"
        );
        this.setState({
  ...
  async componentDidUpdate(prevProps, prevState, snapshot) {
    if (prevProps.language !== this.props.language) {
      try {
        let res =
          await getAllSpecialtyAndProvinceForMedicalFacilityManagePage();
        if (res && res.specialtyData && res.provinceData) {
          let specialtyOptions = this.buildDataForSelectBox(
            res.specialtyData,
            "specialtySelection"
  ...
  render() {
    return (
      <div className="medical-facility-manage-container">
        <div className="medical-facility-manage-form-title title mb-4">
          Thông tin cho Cơ sở Y tế
        </div>
        <div className="container mt-5">
          <div className="row">
              ...
              <div className="row row-in-form">
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    ...
                    required
                    onChange={(event) =>
                      this.handleOnChangeText(event, "medicalFacilityName")
                    }
                ...
                <div className="col-md-12 mb-3">
                  ...
                  <input
                    ...
                    required
                    onChange={(event) =>
                      this.handleOnChangeText(event, "medicalFacilityAddress")
                    } // Sử dụng hàm mới
                ...
                <div className="col-md-12 mb-3">
                  <label className="facility-manage-page-title">
                    Chọn các chuyên khoa của Cơ sở
                  </label>
                  <Select
                    isMulti
            ...
            <div className="col-md-4 image-preview-section">
              <div className="image-preview-container">
                <label className="facility-manage-page-title">
                  Ảnh đại diện của cơ sở Y tế (Logo, tên viết tắt,...)
                </label>
                <div
          ...
          <label className="facility-manage-page-title">
            Bài báo giới thiệu chung về cơ sở
          </label>
          ...
          <label className="facility-manage-page-title">
            Bài báo về trang thiết bị của cơ sở
          </label>
          ...
          <div className="save-facility-button">
            <button onClick={() => this.handleSaveMedicalFacilityInformation()}>
              Thêm cơ sở Y tế
            </button>
          </div>
        </div>
