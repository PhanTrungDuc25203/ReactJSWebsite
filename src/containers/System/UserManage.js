    ...
    render() {
        ...
        return (
            <div className="user-display-container">
                ...
                />
                <ModalEditUser toggleUserModal={this.toggleEditUserModal} isOpen={this.state.modalEditUserOpened} className={"edit-user-modal"} needEdittingUserInfo={this.state.needEdittingUserInfo} editUser={this.editUser} />
                <div className="title table-title">
                    Manage users
                    <div className="mx-1">
                        <button className="btn btn-primary add-new-user-button" onClick={() => this.handleAddNewUserInReact()}>
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className="action-column">
                                                <button className="modify-data-button edit-button" onClick={() => this.setStateForHandleEditUser(item)}>
                                                    <i className="fas fa-pencil-alt"></i>
                                                </button>
                                                <button className="modify-data-button delete-button" onClick={() => this.deleteUser(item)}>
