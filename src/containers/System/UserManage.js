        ...
        <div className="title table-title">
          ...
          <div className="mx-1">
            <button
              ...
              onClick={() => this.handleAddNewUserInReact()}
            >
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="action-column">
                        <button
                          className="modify-data-button edit-button"
                          onClick={() => this.setStateForHandleEditUser(item)}
                        >
                          <i className="fas fa-pencil-alt"></i>
                        </button>
                        <button
                          className="modify-data-button delete-button"
