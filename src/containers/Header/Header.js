            ...
            <div className="header-container">
                ...
                <div className="switch-languages-and-logout">
                    <span className="welcome">
                        <FormattedMessage id="menu.content.welcome-text" />
                        {userInfo && userInfo.firstName ? ", " + userInfo.firstName : ""} !
                    </span>
                    <span className={language === LANGUAGES.VI ? "vietnamese active" : "vietnamese"} onClick={() => this.handleSwitchLanguage(LANGUAGES.VI)}>
                        Vie
                    </span>
                    <span className={language === LANGUAGES.EN ? "english active" : "english"} onClick={() => this.handleSwitchLanguage(LANGUAGES.EN)}>
                        Eng
                    </span>
