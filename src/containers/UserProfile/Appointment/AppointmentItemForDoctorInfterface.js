...
class AppointmentItemForDoctorInfterface extends Component {
  ...
  generatePatientReport = (actionFrom) => {
    ...
    Thông tin bệnh nhân:
        ...
        - Bệnh nhân: ${
          patientInfor
            ? patientInfor.lastName + " " + patientInfor.firstName
            : "Không có"
        }
  ...
  render() {
    ...
    if (patientInfor && patientInfor.image) {
      patientImageByBase64 = Buffer.from(patientInfor.image, "base64").toString(
        "binary"
      );
    }
      ...
      <div className="appointment-item-for-doctor-interface">
        <div className="patient-avatar-container">
          <div
            ...
            style={{
              backgroundImage: `url(${
                patientImageByBase64 ? patientImageByBase64 : defaultAvatar
              })`,
            }}
          ></div>
        </div>
        <div className="appointment-item-for-doctor-info">
          ...
          <div className="patient-name">
            ...
            <span className="appointment-item-for-doctor-content">
              {patientInfor && patientInfor.lastName
                ? patientInfor.lastName
                : ""}
              {patientInfor && patientInfor.firstName
                ? " " + patientInfor.firstName
                : ""}
            </span>
            {". "}
