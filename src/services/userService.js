...
const getEliteDoctorsForHomePageService = (limitEliteDoctor) => {
  return axios.get(
    `/api/get-elite-doctor-for-homepage?limitEliteDoctor=${limitEliteDoctor}`
  );
};
...
const getInforAndArticleForADoctor = (id) => {
  return axios.get(
    `/api/get-a-particular-doctor-infor-for-his-or-her-page?id=${id}`
  );
};
...
const getAllSpecialtyDetailsById = (data) => {
  return axios.get(
    `/api/get-specialty-by-id?id=${data.id}&location=${data.location}`
  );
};

const getAllRelativeInforsOfCurrentSystemUserService = (email) => {
  return axios.get(
    `/api/get-all-relative-infors-of-current-system-user?email=${email}`
  );
};

const getAllRelativeBookingsOfCurrentSystemUserService = (email) => {
  return axios.get(
    `/api/get-all-relative-bookings-of-current-system-user?email=${email}`
  );
};
...
const getAppointmentHistoriesByDoctorEmail = (doctorEmail) => {
  return axios.get(
    `/api/get-appointement-histories-by-doctor-email?doctorEmail=${doctorEmail}`
  );
};
...
const getPackageScheduleByDateService = (packageId, date) => {
  return axios.get(
    `/api/get-package-schedule-by-date?packageId=${packageId}&date=${date}`
  );
};
