...
export const getRequiredDataForDoctorArticleManagePage = () => {
    return async (dispatch, getState) => {
        try {
            ...
            if (resPrice && resPrice.errCode === 0 && resPaymentMethod && resPaymentMethod.errCode === 0 && resProvince && resProvince.errCode === 0 && resSpecialty && resSpecialty.errCode === 0) {
                let data = {
...
export const getRequiredDataForExamPackageManagePage = () => {
    return async (dispatch, getState) => {
        try {
            ...
            if (resPrice && resPrice.errCode === 0 && resPrice && resPrice.errCode === 0 && resMedicalFacility && resMedicalFacility.errCode === 0 && resSpecialty && resSpecialty.errCode === 0) {
                let data = {
                    resPrice: resPrice.data,
